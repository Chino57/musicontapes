...
<body>
	...
	<div class="backgroundImage"></div>
		...
		<article>
		<p id="texterreur">Vous êtes maintenant deconnecté.Cliquez sur le lien suivant si vous n'êtes pas revenu automatiquement sur la page d'accueil<a href="\projet\accueil.php" class ="lienclique"> ici</a>
		</p>
		</article>
		</section>
	<div class = "flexfoot">
