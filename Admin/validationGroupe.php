...
<body>
	...
	<div class="backgroundImage"></div>
		<section class="sectionflex">
			...
			<article>
				<p id="texterreur">Le groupe est bien enregistré dans la base de donnée<br>
				Si vous n'avez pas été redirigé vers le formulaire,cliquez sur ce lien <a href="formulaireGroupe.php" class="lienclique">ici</a>
				</p>
			</article>
