...
<body>
    ...
    <article>
        ...
        <!-- Objectif : faire apparaitre la liste des artistes en utilisant la base de donnée -->
    ...
    while($donnees = $reponse->fetch())
    {
        ...
        <p class="groupe"><?php echo "<a href=groupe.php?id=" .$donnees["id"]." class=lienclique>". htmlspecialchars($donnees["nom"]) ."</a>";?></p>
