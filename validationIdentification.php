...
<body>
	...
	<div class="backgroundImage"></div>
		...
		<article>
		<p id="texterreur">Identification correcte. Bienvenue sur Music On Tapes<br>
		Si vous n'avez pas été redirigé vers le formulaire,cliquez sur ce lien <a href="accueil.php" class ="lienclique">ici</a>
		</p>
		</article>
		</section>
	<div class = "flexfoot">
