...
<head>
	<meta charset="UTF-8">
	<title>Erreur mail identique base de donnée</title>
...
<body>
	<!-- Message d'erreur avec lien en cas de dysfonctionnement du script  -->
	...
	<div class="backgroundImage"></div>
		<section class="sectionflex">
			<article>
				...
				<p id="texterreur">Votre adresse mail est déjà dans notre base de donnée.</br>
				Veuillez choisir une autre adresse mail
				</p>
			</article>
		</section>
	<div class = "flexfoot">
